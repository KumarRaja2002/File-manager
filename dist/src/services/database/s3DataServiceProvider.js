...
export class s3FileService {
    ...
    constructor() {
        ...
        configData.s3.s3_bucket = process.env.B2_BUCKET_NAME || 'file-manager-dev';
    }
    ...
    public async getPresignedUrl(file_name: string, file_type: string): Promise<{ presignedUrl: string }> {
